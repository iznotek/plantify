...
export class HeatControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Heat })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: HeatCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Heat] })
  @swagger.ApiForbiddenResponse()
  @swagger.ApiQuery({
    type: () => HeatFindManyArgs,
    style: "deepObject",
    explode: true,
  })
  async findMany(
    ...
    const args = plainToClass(HeatFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: HeatWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Heat | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
  ...
  async createFoods(
    @common.Param() params: HeatWhereUniqueInput,
    @common.Body() body: HeatWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      foods: {
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"Heat"} is forbidden for roles: ${roles}`
      );
    }
