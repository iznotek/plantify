...
export class DirectionControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Direction })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: DirectionCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Direction] })
  @swagger.ApiForbiddenResponse()
  @swagger.ApiQuery({
    type: () => DirectionFindManyArgs,
    style: "deepObject",
    explode: true,
  })
  async findMany(
    ...
    const args = plainToClass(DirectionFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: DirectionWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  async createFoods(
    @common.Param() params: DirectionWhereUniqueInput,
    @common.Body() body: DirectionWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      foods: {
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"Direction"} is forbidden for roles: ${roles}`
      );
    }
